...
export interface LSP8IdentifiableDigitalAssetInitInterface extends ethers.utils.Interface {
    functions: {
...
export interface LSP8IdentifiableDigitalAssetInit extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LSP8IdentifiableDigitalAssetInitInterface;
