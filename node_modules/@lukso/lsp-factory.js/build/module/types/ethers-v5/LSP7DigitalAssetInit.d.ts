...
export interface LSP7DigitalAssetInitInterface extends ethers.utils.Interface {
    functions: {
...
export interface LSP7DigitalAssetInit extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LSP7DigitalAssetInitInterface;
