...
export interface LSP8CompatibilityForERC721Interface extends ethers.utils.Interface {
    functions: {
...
export interface LSP8CompatibilityForERC721 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LSP8CompatibilityForERC721Interface;
