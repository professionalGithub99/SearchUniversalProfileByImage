...
export interface LSP7CappedSupplyInitInterface extends ethers.utils.Interface {
    functions: {
...
export interface LSP7CappedSupplyInit extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LSP7CappedSupplyInitInterface;
    ...
    functions: {
        ...
        "initialize(string,string,address,bool)"(name_: string, symbol_: string, newOwner_: string, isNFT_: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "initialize(string,string,address,bool)"(name_: string, symbol_: string, newOwner_: string, isNFT_: boolean, overrides?: CallOverrides): Promise<void>;
